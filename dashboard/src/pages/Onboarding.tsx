...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-50">
      {/* Progress Header */}
      <div className="bg-white border-b border-brand-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-3xl mx-auto px-4 py-4 flex flex-col items-center justify-center">
          ...
          <span className="text-xs font-semibold text-brand-400 mt-3 uppercase tracking-widest">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-sm border border-brand-200 p-8 sm:p-12 overflow-hidden relative">
